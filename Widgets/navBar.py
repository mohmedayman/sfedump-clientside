...
from Screens.Dashboard.dashboard import DashboardWidget
def createNavBar(parent):
    # Create tabs
        parent.dashboard_tab =DashboardWidget()
        ...
        parent.tabs.addTab(parent.intruder_tab, "Fuzzer")
        parent.tabs.addTab(parent.repeater_tab, "Sender")
        ...
        parent.tabs.addTab(parent.jwt_tab, "Jwt")

...
from Service.HostDiscovery import ip_scanner
...
def setup_ip_scanner_tab(self: QObject, ip_scanner_tab):
    ...
    api = ip_scanner.IPScannerService(self, button=search_button, output=self.res_box)
    layout = QVBoxLayout()
    ...
    search_button.clicked.connect(lambda _: api.ip_scanner(
    ...
    ip_scanner_tab.setLayout(layout)
